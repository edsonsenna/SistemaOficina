...
public class TelaResultadosBuscaProduto extends javax.swing.JFrame {
     ...
     * @param pessoas
     */
    public TelaResultadosBuscaProduto() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaResultadosBuscaProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaResultadosBuscaProduto().setVisible(true);    
            }
        });
    }

...
public class TelaCadastroOrcamento extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        linha.add(this.produtobusca.getCod());
        linha.add(this.produtobusca.getNome());
        linha.add(this.produtobusca.getValorVenda());
        linha.add(this.produtobusca.getValorCompra());
        linha.add(this.produtobusca.getQnt());
        linha.add(this.produtobusca.getDescricao());
        linha.add(this.produtobusca.getDataCadastro());
        modelo.addRow(linha);

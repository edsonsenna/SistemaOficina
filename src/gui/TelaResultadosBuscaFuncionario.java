 ...
 * @author 13151000162
 */
public class TelaResultadosBuscaFuncionario extends javax.swing.JFrame {
     ...
     * @param pessoas
     */
    public TelaResultadosBuscaFuncionario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaResultadosBuscaFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaResultadosBuscaFuncionario().setVisible(true);    
            }
        });
    }

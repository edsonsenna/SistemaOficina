 ...
 * @author 13151000162
 */
public class TelaEditarProd extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	produto.setValorCompra(Double.parseDouble(jTextField2.getText()));
    	produto.setValorVenda(Double.parseDouble(jTextField3.getText()));
    	produto.setQnt(Integer.parseInt(jTextField6.getText()));
    	produto.setDataCadastro(jFormattedTextField1.getText());
    	produto.setDescricao(jTextField4.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEditarProd().setVisible(true);
            }
        });
    }
